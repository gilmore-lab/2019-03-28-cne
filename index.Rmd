...
## What if Marr was wrong (or we took him too literally)?
...
- Dimensionality of input stream ($S$) state space mappings
...
- Access to sufficiently rich datasets
- Clear specification of controlled systems & control variables
- Widespread open sharing of systems & variables
